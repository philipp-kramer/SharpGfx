...
extern "C"
{
    ...
    EXPORT void uniform1fv(const unsigned int location, int count, const float* values) { glUniform1fv(location, count, values); }
    EXPORT void uniform3fv(const unsigned int location, int count, const float* values) { glUniform3fv(location, count, values); }
