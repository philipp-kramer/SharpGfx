...
namespace SharpGfx.Geometry
{
    public static class Quad
    {
        ...
        public static float[] GetFlatVertices(Func<float, float, float> f)
        {
            return new[]{
        ...
        public static float[] GetFlatNormals(Func<float, float, float> f)
        {
            ...
            var d = shared - origin;
            var n0 = Vector3.Cross(d, t0 - origin).Normalized();
            var n1 = Vector3.Cross(t1 - origin, d).Normalized();
