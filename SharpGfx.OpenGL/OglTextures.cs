...
namespace SharpGfx.OpenGL
{
    internal static class OglTextures
    {
        public static uint CreateTexture(IVector2 pixels, GlPixelFormat pixelFormat, GlPixelType pixelType)
        {
            ...
            GL.TextureParameterI(texture, GlTextureParameterName.TextureMinFilter, GlTextureParameter.Linear);
            GL.TextureParameterI(texture, GlTextureParameterName.TextureMagFilter, GlTextureParameter.Linear);
